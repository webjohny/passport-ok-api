...
Strategy.prototype.userProfile = function (accessToken, done) {
	'use strict';
	console.log(this.oauth2.__clientId);
	this._oauth2.getProtectedResource('http://api.odnoklassniki.ru/fb.do?method=users.getCurrentUser&application_key=' +  + '&sig=' + , accessToken, function (err, body, res) {
